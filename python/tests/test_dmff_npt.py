...
def test_dmff_npt_reference(nsteps = 1000, time_step = 0.2, platform_name = "Reference", output_temp_dir = "/tmp/openmm_dmff_plugin_test_npt_output", density_std_tol = 0.2 ):
...
def test_dmff_npt_cuda(nsteps = 1000, time_step = 0.2, platform_name = "CUDA", output_temp_dir = "/tmp/openmm_dmff_plugin_test_npt_output", density_std_tol = 0.2 ):
    if not os.path.exists(output_temp_dir):
        os.mkdir(output_temp_dir)
