...
def test_dmff_nvt_reference(nsteps = 1000, time_step = 0.2, platform_name = "Reference", output_temp_dir = "/tmp/openmm_dmff_plugin_test_nvt_output", temperature_std_tol = 25 ):
...
def test_dmff_nvt_cuda(nsteps = 1000, time_step = 0.2, platform_name = "CUDA", output_temp_dir = "/tmp/openmm_dmff_plugin_test_nvt_output", temperature_std_tol = 25 ):
    if not os.path.exists(output_temp_dir):
        os.mkdir(output_temp_dir)
