...
def test_dmff_alchemical_reference(nsteps = 1000, time_step = 0.2, Lambda = 0.0, platform_name = "Reference", output_temp_dir = "/tmp/openmm_dmff_plugin_test_alchemical_output", temperature_std_tol = 25):
...
def test_dmff_alchemical_cuda(nsteps = 1000, time_step = 0.2, Lambda = 1.0, platform_name = "CUDA", output_temp_dir = "/tmp/openmm_dmff_plugin_test_alchemical_output", temperature_std_tol = 25):
    if not os.path.exists(output_temp_dir):
        os.mkdir(output_temp_dir)
...
if __name__ == "__main__":
    test_dmff_alchemical_reference()
    test_dmff_alchemical_cuda()